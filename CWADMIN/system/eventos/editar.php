        ...
        <div class="col-md-12">
            ...
            if (isset($dados) && $dados['SendPostForm']):
                ...
                if (!$cadastra->getResult()):
                    ...
                    header("Location: painel.php?exe=eventos/listar&acao=cadastrar&id={$idEdit}");
                endif;
            else:
                $read = new Read;
                $read->ExeRead("eventos", "WHERE id = :id", "id={$idEdit}");
                if (!$read->getResult()):
                    header("Location: painel.php?exe=eventos/listar");
                else:
